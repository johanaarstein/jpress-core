...
if ($lang == 'no') {
	...
	$strArray = array(
		...
		$faviconSpecs_str = 'Favicon må være .png, og helst 600 x 600 px',
	  ...
	  $metaTags_str = 'Metatagger',
		$addCodeHead_str = 'Legg til kode i <small>&lt;head&gt;</small>',
		$addCodeBody_str = 'Legg til kode i toppen av <small>&lt;body&gt;</small>',
		$addCodeFooter_str = 'Legg til kode i bunnen av <small>&lt;body&gt;</small>',
	  ...
	  $english_str = 'Engelsk',
		...
		$altSiteTitle_str = 'Nettsidetittel på alternativt språk',
	...
	$strArray = array(
		...
		$faviconSpecs_str = 'Favicon must be .png, and preferably 600 by 600 px',
	  ...
	  $metaTags_str = 'Meta Tags',
		$addCodeHead_str = 'Add code to <small>&lt;head&gt;</small>',
		$addCodeBody_str = 'Add code to top of <small>&lt;body&gt;</small>',
		$addCodeFooter_str = 'Add code to bottom of <small>&lt;body&gt;</small>',
	  ...
	  $english_str = 'English',
		...
		$altSiteTitle_str = 'Website title for Alternate Language',
